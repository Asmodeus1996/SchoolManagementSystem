         ...
         <!-- SIDEBAR -->
			<div class="sidebar" style="background-image: url(sidebar-1.jpg)">
				<div class="sidebar-background" >
					...
					<div class="left-menu">
						<a class="active"  href="adm-page.jsp?pgprt=0"><h2>View Profile</h2></a>
						...
						<a href="adm-page.jsp?pgprt=1"><h2>Student Profiles</h2></a>
                                                <a href="adm-page.jsp?pgprt=5"><h2>Test Results</h2></a>
					</div>
				</div>
			</div>
            <!-- CONTENT AREA -->
			...
			<div class="sidebar" style="background-image: url(sidebar-1.jpg)">
				<div class="sidebar-background" >
					...
					<div class="left-menu">
						<a class="active" href="std-page.jsp?pgprt=0"><h2>View Profile</h2></a>
						<a href="std-page.jsp?pgprt=1"><h2>Online Test</h2></a>
