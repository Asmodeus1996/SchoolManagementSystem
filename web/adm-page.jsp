...
<body>
	<div class="top-area">
		<center><h2><font color="Green">Administrator Home Page</h2></center> <a href="controller.jsp?page=logout" class="button" style="float: right;background:crimson;color:white">Logout</a>
	</div>
